...
class EvolutionChain extends React.Component {
  ...
  render() {
    if (this.state.error) {
        ...
        if (this.props.name===chainData.species.name) {
          ...
          if (chainData["evolves_to"].length>=2) {
            ...
            return chainData["evolves_to"].map((branch) => {
              ...
              : branchChain["known_move"] ? `when leveled up while knowing ${this.splitAndPunctuate(branchChain["known_move"].name)}.`
              ...
              : branchChain["time_of_day"] ? `when leveled up during the ${branchChain["time_of_day"]}.`
      ...
      : stageOneChain["known_move"] ? `when leveled up while knowing ${this.splitAndPunctuate(stageOneChain["known_move"].name)}.`
      ...
      : stageOneChain["time_of_day"] ? `when leveled up during the ${stageOneChain["time_of_day"]}.`
      ...
      : `at level ${stageOneChain["min_level"]}.`}</div>
          ...
          if (chainData["evolves_to"][0]["evolves_to"].length>=2) {
            ...
            if (chainData["evolves_to"][1]) {
              ...
              : stageTwoChain["known_move"] ? `when leveled up while knowing ${this.splitAndPunctuate(stageTwoChain["known_move"].name)}.`
              ...
              : stageTwoChain["time_of_day"] ? `when leveled up during the ${stageTwoChain["time_of_day"]}.`
              ...
              : `at level ${stageTwoChain["min_level"]}.`}</div>
                ...
                return <div id="display3">{`It evolves to ${this.splitAndPunctuate(chainData["evolves_to"][1]["evolves_to"][0].species.name)} `}{stageTwoBranch["gender"] ? stageTwoBranch["gender"] === 1 ? stageTwoBranch["item"] ? `if female and exposed to the ${this.splitAndPunctuate(stageTwoBranch["item"].name)} item.` : `if female at level ${stageTwoBranch["min_level"]}.` : stageTwoBranch["item"] ? `if male and exposed to the ${this.splitAndPunctuate(stageTwoBranch["item"].name)} item.` : `if male at level ${stageTwoBranch["min_level"]}.`
              ...
              : stageTwoBranch["known_move"] ? `when leveled up while knowing ${this.splitAndPunctuate(stageTwoBranch["known_move"].name)}.`
              ...
              : stageTwoBranch["time_of_day"] ? `when leveled up during the ${stageTwoBranch["time_of_day"]}.`
